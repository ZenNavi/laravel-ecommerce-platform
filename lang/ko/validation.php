...
return [
    ...
    'ascii' => ':attribute은(는) 싱글바이트 영숫자와 기호만 포함해야 합니다.',
    ...
    'decimal' => ':attribute은(는) :decimal 자리 소수여야 합니다.',
    ...
    'doesnt_end_with' => ':attribute은(는) :values 중 하나로 끝나면 안 됩니다.',
    'doesnt_start_with' => ':attribute은(는) :values 중 하나로 시작하면 안 됩니다.',
    ...
    'min_digits' => ':attribute은(는) 최소 :min 자리 이상이어야 합니다.',
    'missing' => ':attribute 필드는 없어야 합니다.',
    'missing_if' => ':other이(가) :value일 때 :attribute 필드는 없어야 합니다.',
    'missing_unless' => ':other이(가) :value이(가) 아닐 때 :attribute 필드는 없어야 합니다.',
    ...
    'password' => [
        ...
        'uncompromised' => '주어진 :attribute이(가) 데이터 유출에 노출되었습니다. 다른 :attribute을(를) 선택하세요.',
    ],
    'present' => ':attribute 필드가 있어야 합니다.',
    'prohibited' => ':attribute 필드는 금지되어 있습니다.',
    'prohibited_if' => ':other이(가) :value일 때 :attribute 필드는 금지되어 있습니다.',
    'prohibited_unless' => ':other이(가) :values에 있지 않으면 :attribute 필드는 금지되어 있습니다.',
    'prohibits' => ':attribute 필드는 :other의 존재를 금지합니다.',
    'regex' => ':attribute 형식이 유효하지 않습니다.',
    'required' => ':attribute 필드는 필수입니다.',
    'required_array_keys' => ':attribute 필드는 :values 항목을 포함해야 합니다.',
    'required_if' => ':other이(가) :value일 때 :attribute 필드는 필수입니다.',
    'required_if_accepted' => ':other이(가) 동의되었을 때 :attribute 필드는 필수입니다.',
    'required_unless' => ':other이(가) :values에 있지 않으면 :attribute 필드는 필수입니다.',
    ...
    'size' => [
        'array' => ':attribute은(는) :size개를 포함해야 합니다.',
