            ...
            <div className="bg-[#F6F6F6] py-6">
                <div className="container mx-auto px-4">
                    <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="text-[#010F1C] font-medium">회원가입</span>
                    </div>
                </div>
            </div>
            ...
            <div className="container mx-auto px-4 py-16">
                <div className="max-w-md mx-auto">
                    <div className="text-center mb-8">
                        <h1 className="text-2xl lg:text-3xl font-bold text-[#010F1C] mb-2">회원가입</h1>
                        <p className="text-[#55585B]">새 계정을 만들어 쇼핑을 시작하세요</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-[#010F1C] mb-2">비밀번호 확인</label>
                            <input
                                type="password"
                        ...
                        <div className="space-y-3">
                            <label className="flex items-start gap-3 cursor-pointer">
                                ...
                                <span className="text-sm text-[#55585B]">
                                    ...
                                    <Link href="/harri/policy" className="text-[#F50963] hover:underline"> 개인정보처리방침</Link>에 동의합니다. (필수)
                                </span>
                            </label>
                            <label className="flex items-start gap-3 cursor-pointer">
                                <input
                    ...
                    <div className="space-y-3">
                        <button className="w-full h-12 border border-[#EAEAEF] flex items-center justify-center gap-3 hover:border-[#010F1C] transition-colors">
                            ...
                            <span className="text-sm font-medium text-[#010F1C]">Google로 가입</span>
                        </button>
