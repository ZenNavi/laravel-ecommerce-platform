...
export default function HarriLayout({ children }) {
            ...
            <header className="bg-white border-b border-[#EAEAEF] sticky top-0 z-50">
                <div className="container mx-auto px-4">
                    <div className="flex items-center justify-between h-20">
                        ...
                        <div className="flex-shrink-0">
                            <Link href="/harri" className="text-2xl font-bold text-[#010F1C] tracking-tight">
                                HARRI
                            </Link>
                        </div>
                ...
                {searchOpen && (
                    <div className="border-t border-[#EAEAEF] py-4">
                        <div className="container mx-auto px-4">
                            <form action="/harri/search" method="GET" className="flex items-center gap-2">
                                <input
                                    type="text"
                                    name="q"
                                    placeholder="상품 검색..."
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                <li>
                                    <Link href="/harri/shop" className="text-sm text-white/60 hover:text-[#F50963] transition-colors">
                                        쇼핑
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/harri/about" className="text-sm text-white/60 hover:text-[#F50963] transition-colors">
                                        회사 소개
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/harri/contact" className="text-sm text-white/60 hover:text-[#F50963] transition-colors">
                                        문의하기
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/harri/faq" className="text-sm text-white/60 hover:text-[#F50963] transition-colors">
                                        FAQ
                                    </Link>
                                </li>
                            </ul>
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                <li>
                                    <Link href="/harri/order" className="text-sm text-white/60 hover:text-[#F50963] transition-colors">
                                        주문 조회
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/harri/policy" className="text-sm text-white/60 hover:text-[#F50963] transition-colors">
                                        배송/반품 정책
                                    </Link>
                                </li>
                                <li>
                                    <Link href="/harri/terms" className="text-sm text-white/60 hover:text-[#F50963] transition-colors">
                                        이용약관
                                    </Link>
                                </li>
                            </ul>
                    ...
                    <div className="container mx-auto px-4 py-6">
                        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                            ...
                            <div className="flex items-center gap-4 text-sm text-white/60">
                                <Link href="/harri/terms" className="hover:text-white transition-colors">이용약관</Link>
                                <span>|</span>
                                <Link href="/harri/policy" className="hover:text-white transition-colors">개인정보처리방침</Link>
                            </div>
                        </div>
                    </div>
                </div>
